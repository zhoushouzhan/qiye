 ...
 * @LastEditTime: 2022-08-23 19:58:08
...
class Category extends Base
{
    ...
    //选择栏目
    public function getSelect($pid = 0, $ids = '', $infoid = 0)
    {
        $dataList = $this->table::order('sort', 'asc')->select();
        return $this->table->getSelected($pid, $ids, $infoid);
    }
