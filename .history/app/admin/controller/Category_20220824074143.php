 ...
 * @LastEditTime: 2022-08-24 07:31:32
...
class Category extends Base
{
    ...
    {
        $dataList = $this->table::order('id', 'asc')->select();
        $data['tree']=layoutCategory($dataList);
        $this->success('获取栏目树成功',);
        return layoutCategory($dataList);
    }
