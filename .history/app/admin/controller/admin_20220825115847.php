 ...
 * @LastEditTime: 2022-08-25 11:58:42
        ...
        if ($this->request->isPost()) {
            ...
            try {
                ...
                if ($admin_id >= 1) {
                    ...
                    $resault['modType'] = Config::get('app.modType');
                    $resault['actions'] = Config::get('app.actions');
                    $resault['formitem'] = Config::get('app.formitem');

                    $this->success('登录成功', $param);
                } else {
                    $this->error('登录失败');
                }
