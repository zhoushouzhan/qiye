 ...
 * @LastEditTime: 2022-09-19 09:25:22
...
class Base extends BaseController
{
    ...
    protected function getMenu($type = '')
    {
        ...
        if ($type == '') {
            ...
            $categoryList = layoutData($newMenu, $content_node_id);
