 ...
 * @LastEditTime: 2022-08-09 07:35:19
...
class Mod extends Model
{
    ...
    //字段别名
    public function setColaliasAttr($value)
    {
    ...
    public function getColaliasAttr($value)
    {
    ...
    //字段
    public function setColsAttr($value)
    {
        if ($value) {
