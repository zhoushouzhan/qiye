 ...
 * @LastEditTime: 2022-09-27 20:30:22
...
class Mod extends Base
{
    ...
    {
        $map[] = ['type', '=', "classic"];
        $dataList = \app\common\model\Mod::where($map)->field('id as value,alias as title')->order('sort', 'asc')->select();
        $this->success('获取内容模型成功', $dataList);
    }
